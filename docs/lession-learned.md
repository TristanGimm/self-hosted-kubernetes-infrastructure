...
The pure suffering and pain caused by endlessly troubleshooting problems consumed immense time which was needed elsewhere. Simplicity over Complexity once again wouldve been better here for this smaller project. (It is no enterprise model)
...
Biggest Takeaway: Be aware of overengineering and focus on Simplicity over Complexity in order to aquire biggest ROI. Simple things at scale tend to become complex and complex architecture at scale tends to become impossible especially if you do it yourself or only in a small team.
