...
This environment is primarily a **single-server self-hosted Kubernetes platform**.

It is not intended to imitate a large production cluster.

Its purpose is to operate real services while providing practical experience with:
...
- [CI/CD](../docs/ci-cd.md)
- [Application Workloads](../docs/application.md)
